...
# following files are generated by preprocess.py
...
TRAIN_LABEL_FILE_COUNTS = os.path.join(DATA_DIR, 'generated_train_labels_counts_7172.csv')
TUNING_LABELS_COUNTS = os.path.join(DATA_DIR, 'tuning_labels_counts.csv')
